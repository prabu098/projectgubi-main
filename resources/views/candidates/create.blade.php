                    ...
                    <div class="card-body">
                        ...
                        <form enctype="multipart/form-data" action="{{route('candidates.store')}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="visi"  id="visi" cols="5" rows="5" class=" form-control {{ $errors->first('visi') ? "is-invalid" : ""}}" required></textarea>

                            </div>
                            <div class="form-group">
                                <label for="">Misi</label>
                                <textarea name="misi"  id="misi" cols="5" rows="5" class="form-control {{ $errors->first('misi') ? "is-invalid" : ""}}"></textarea>
                                <p class="text-danger">{{ $errors->first('misi') }}</p>
                            </div>
                            <div class="form-group">
                                <label for="">Program Kerja</label>
                                <textarea name="program_kerja"  id="program_kerja" cols="5" rows="5" class=" form-control {{ $errors->first('program_kerja') ? "is-invalid" : ""}}"></textarea>
