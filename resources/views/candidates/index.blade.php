                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td width="100px">{{$candidate->nama_ketua}}</td>
                                    <td width="100px">{{$candidate->nama_wakil}}</td>
                                    <td width="300px" height="auto">{{$candidate->visi}}</td>
                                    <td width="300px" height="auto">{{$candidate->misi}}</td>
                                    <td width="300px" height="auto">{{$candidate->program_kerja}}</td>
                                    <td>
